...
INSERT INTO `catergoryfilters` VALUES (2,3),(3,3),(4,3),(5,3),(6,3),(7,3),(8,3),(9,3),(10,3),(11,3);
...
CREATE TABLE `coupontokens` (
  ...
  KEY `sadsdg_idx` (`email`),
  CONSTRAINT `sadsdg` FOREIGN KEY (`email`) REFERENCES `users` (`email`),
...
INSERT INTO `login` VALUES ('bly02756@zslsz.com','a',NULL),('eyx66209@zbock.com','c',NULL);
...
INSERT INTO `productfilters` VALUES (2,1,'Apple'),(6,1,'16GB');
...
INSERT INTO `productphoto` VALUES (1,1,'assets/databaseImages/products/885909950652/imgname.jpg'),(7,6,'assets/databaseImages/products/123/red panda.png'),(8,6,'assets/databaseImages/products/123/red panda2.png'),(9,7,'assets/databaseImages/products/21435/Dark Fantasy1.png'),(10,7,'assets/databaseImages/products/21435/Dark Fantasy2.png'),(11,7,'assets/databaseImages/products/21435/Dark Fantasy3.png'),(12,7,'assets/databaseImages/products/21435/Dark Fantasy4.png'),(13,8,'assets/databaseImages/products/543/minotaur.png'),(14,9,'assets/databaseImages/products/1234/minotaur.png'),(15,10,'assets/databaseImages/products/345/minotaur.png'),(16,11,'assets/databaseImages/products/999/castle1.png'),(17,11,'assets/databaseImages/products/999/castle2.png'),(18,11,'assets/databaseImages/products/999/castle3.png'),(19,11,'assets/databaseImages/products/999/castle4.png'),(20,12,'assets/databaseImages/products/55/brokenmoon.png');
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `group_buy`.`products_BEFORE_DELETE`
...
INSERT INTO `users` VALUES (7,'a','a','bly02756@zslsz.com','null','a',1,NULL,0,0,NULL,NULL,'8f4189b0-8d6c-4636-b');
...
-- Dump completed on 2023-06-11 23:37:34

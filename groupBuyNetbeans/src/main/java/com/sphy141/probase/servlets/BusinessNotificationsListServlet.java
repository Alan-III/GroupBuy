 ...
 * @author Alan
 */
@WebServlet(urlPatterns = {"/businessnotifications"})
public class BusinessNotificationsListServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            notificationsList = DBUtils.queryNotifications(conn, business);
        ...
        RequestDispatcher dispatcher=this.getServletContext().getRequestDispatcher("/WEB-INF/views/businessNotificationsView.jsp");
